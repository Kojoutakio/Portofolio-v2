      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://files.catbox.moe/s8phd5.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Kojouta. I'm a 3D animator And 3D model artist from Jakarta, West Java. I
            have 2 year of experience in in 3D modeling and Animation.
          ...
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My job is to help you in 3D modeling.
            In addition, I give some details to your 3D modeling and make sure that the Model is optimized and avoids lag so that the game runs smoothly.
